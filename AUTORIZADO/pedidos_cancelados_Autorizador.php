<?php
	...
	$contulta_pedido_cancelado = "SELECT P.cod_pedido, P.data_Pedido, P.hora, E.nome, PC.motivo FROM pedido AS P INNER JOIN usuario AS U ON P.solicitante = U.matricula and U.fk_Setor=$setor INNER JOIN estado as E ON P.fk_Estado = E.cod_Estado INNER JOIN pedido_cancelado AS PC ON (P.fk_pedido_cancelado = PC.cod_pedido_cancelado) WHERE (E.cod_estado=4 OR E.cod_estado=3)";

	/*$contulta_pedido_cancelado = "SELECT P.cod_pedido, P.data_Pedido, P.hora, E.nome, E.cod_estado, PC.motivo FROM pedido as P INNER JOIN estado as E ON (P.solicitante = $matricula AND P.fk_Estado = E.cod_Estado) INNER JOIN  pedido_cancelado AS PC ON (P.fk_pedido_cancelado = PC.cod_pedido_cancelado) WHERE (E.cod_estado=4 OR E.cod_estado=3) ORDER BY P.data_Pedido DESC";*/
								  ...
								  <tbody>
								       ...
								       <?php 											
											while($dado = mysql_fetch_assoc($connect_pedido)) { 
                                                ...
                                                <td style="width:200px"><font size="3"><center><?=$dado['motivo']?></center></font></td>
