...
<body>
	<?php
		...
		$insere_pedido = "INSERT INTO pedido(solicitante, data_Pedido, fk_Estado, hora, data_hora) VALUES ($matricula,'$dataFormatada', 5, '$hora', '$data_hora')";
		...
		if(isset($_SESSION['item']) && isset($_SESSION['quantidade'])) {
			...
			for( $x=0; $x < $i; $x++)
			{
                ...
                {
                    echo"<script type='text/javascript'>alert('Pedido realizado com sucesso!');window.location.href='acompanhar_Pedido_Almoxarifado.php';</script>";
                }
			}
		}
	?> 
