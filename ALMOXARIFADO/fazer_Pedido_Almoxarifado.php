					...
					<div class="formPedido">  
						<form id="formPedido" action="lista_item.php" method="POST">
							<div id="inicio_div">
                                ...
                                <input disabled type="text" name="nome" value="<?php echo $linha['nome'];?>"/>
                                <input hidden type="text" name="nome" value="<?php echo $linha['cod_setor'];?>"/>
							</div>
							<br>
                            <p>
							...
							<div id="div_pedidos" >
                                ...
                                <input type="text"  required="required" placeholder="Quantidade" name="quantidade[]" onkeypress="return SomenteNumero()">
							</div >	
                            <div id="lista_itens">								
							</div>
